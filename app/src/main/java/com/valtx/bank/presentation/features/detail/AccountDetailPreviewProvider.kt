...
class AccountDetailPreviewProvider : PreviewParameterProvider<AccountDetailUi> {

    override val values: Sequence<AccountDetailUi> = sequenceOf(
        AccountDetailUi(
            id = 1,
            name = "Cuenta soles",
            ...
            transactions = listOf(
                ...
                TransactionUi(
                    ...
                    date = "07 Ene 2025",
                    currency = Currency.PEN,
                    amount = BigDecimal("3200.00".replace(",", ""))
                ),
                TransactionUi(
                    id = 12,
                    description = "Netflix",
